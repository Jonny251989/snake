/****************************************************************************
** Meta object code from reading C++ file 'inputname.h'
**
...
#include <memory>
#include "../../../../../menu/inputname/inputname.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'inputname.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(10, 11), // "closeWindow"
QT_MOC_LITERAL(22, 0), // ""
QT_MOC_LITERAL(23, 3), // "str"
QT_MOC_LITERAL(27, 17) // "on_ok_but_clicked"

    },
    "InputName\0closeWindow\0\0str\0on_ok_but_clicked"
};
...
void InputName::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->closeWindow((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 1: _t->on_ok_but_clicked(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (InputName::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&InputName::closeWindow)) {
                *result = 0;
                return;
            }
        }
...
, QtPrivate::TypeAndForceComplete<InputName, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<QString, std::false_type>
...
// SIGNAL 0
void InputName::closeWindow(QString _t1)
{
